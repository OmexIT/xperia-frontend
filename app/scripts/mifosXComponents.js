define(['Q', 'underscore', 'mifosX'], function (Q) {
    var components = {
        ...
        controllers: [
            ...
            'groups/TransferGroupController',
			...
			'datamigration/ImportLoanController',
			'datamigration/ImportClientController',
            'datamigration/ImportOfficeController',
            'datamigration/ImportStaffController',
			'datamigration/ImportUserController',
			'datamigration/ImportCodeController',
			'datamigration/ImportSavingController',
			'datamigration/ImportGroupController',
			'datamigration/ImportCenterController',
            'smscampaign/SmsCampaignController'
        ],
        filters: [
            'StatusLookup',
            'DateFormat',
