(function (mifosX) {
    var defineRoutes = function ($routeProvider, $locationProvider) {
        $routeProvider
			...
			.when('/mobilemoneyreconciliation', {
                templateUrl: 'views/mpesa/mpesareconciliation.html'
            }) 
            ...
            .when('/importuser', {
                templateUrl: 'views/datamigration/importuser.html'
            })
            .when('/importclient', {
                templateUrl: 'views/datamigration/importclient.html'
            })
            .when('/importloan', {
                templateUrl: 'views/datamigration/importloan.html'
            })
            .when('/import', {
                templateUrl: 'views/datamigration/import.html'
            })
            .when('/importoffice', {
                templateUrl: 'views/datamigration/importoffice.html'
            })
            .when('/importcode', {
                templateUrl: 'views/datamigration/importcode.html'
            })
            .when('/importgroup', {
                templateUrl: 'views/datamigration/importgroup.html'
            })
            .when('/importsaving', {
                templateUrl: 'views/datamigration/importsaving.html'
            })
            .when('/importcenter', {
                templateUrl: 'views/datamigration/importcenter.html'
            })
            .when('/importstaff', {
                templateUrl: 'views/datamigration/importstaff.html'
            })
        ;
