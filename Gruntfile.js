        ...
        uglify: {
            ...
            prod: {
                files: [{
                    ...
                    // '<%= mifosx.dist %>/<%=mifosx.target%>/bower_components/angular-cron-jobs/dist/angular-cron-jobs.min.js': ['<%= mifosx.app %>/bower_components/angular-cron-jobs/dist/angular-cron-jobs.min.js']
                }]
            }
        },
